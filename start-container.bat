docker rm -f nn
docker run -itd --name=nn --hostname=nn --network=hnet -P -p 9870:9870 -p 8088:8088 -p 9000:9000 --ip=172.20.1.0 --add-host=dn1:172.20.1.1 --add-host=dn2:172.20.1.2 --privileged cluster_proto /usr/sbin/init
docker rm -f dn1
